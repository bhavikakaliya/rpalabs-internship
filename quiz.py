...
class quiz:
    ...
    # arguments = correct: correct option, numOptions: number of options available for the question
    def checkAnswer(self, correct, numOptions):
        while(True):
            ...
            if x.isnumeric():
                ...
                elif int(x) not in range(1, numOptions+1):
                    print("Please enter a valid choice or 'pass'.")
